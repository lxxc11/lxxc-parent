...
public class SecurityUtils {
    ...
    public static User getCurrentUserObject() {
        ...
        LoginUser loginUser = (LoginUser) org.apache.shiro.SecurityUtils.getSubject().getPrincipal();
        RemoteUser user = new RemoteUser();
        user.setId(loginUser.getUserName());
        user.setDisplayName(loginUser.getRealName());
        user.setFirstName(loginUser.getRealName());
        user.setLastName(loginUser.getRealName());
