package com.lvxc.enc.properties;
...
import com.lvxc.enc.encryptor.SimpleAsymmetricConfig;
import com.lvxc.enc.encryptor.SimpleAsymmetricStringEncryptor;
import com.lvxc.enc.encryptor.SimpleGCMConfig;
import com.lvxc.enc.util.AsymmetricCryptography.KeyFormat;
import com.lvxc.enc.encryptor.SimpleGCMStringEncryptor;
import lombok.Data;
...
@ConfigurationProperties(prefix = "lvxc.encrypt", ignoreUnknownFields = true)
@Data
public class JasyptEncryptorConfigurationProperties {
     ...
     * @return a {@link JasyptEncryptorConfigurationProperties} object
     */
    public static JasyptEncryptorConfigurationProperties bindConfigProps(ConfigurableEnvironment environment) {
        ...
        binder.bind("lvxc.encrypt", target, handler);
        return config;
    }
     ...
     *
     * @see SimpleAsymmetricStringEncryptor
     ...
     * @see RefreshScopeRefreshedEventListener
     */
