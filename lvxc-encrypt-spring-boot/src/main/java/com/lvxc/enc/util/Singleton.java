...
public final class Singleton<R> implements Supplier<R> {
     ...
     * <p>from.</p>
     *
     * @param original a {@link Supplier} object
     * @param <R> a R class
     ...
     * <p>from.</p>
     *
     * @param original a {@link Function} object
     ...
     * <p>from.</p>
     *
     * @param original a {@link BiFunction} object
     * @param arg0 a T object
     ...
     *
     * @param original a {@link Function} object
     * @param arg0Supplier a {@link Supplier} object
     * @param <T> a T class
     * @param <R> a R class
     * @return a {@link Singleton} object
     */
     ...
     * @param original a {@link BiFunction} object
     * @param arg0Supplier a {@link Supplier} object
     * @param arg1Supplier a {@link Supplier} object
     * @param <T> a T class
     * @param <U> a U class
     * @param <R> a R class
     * @return a {@link Singleton} object
