...
import com.lvxc.enc.annotation.EncryptablePropertySource;
import com.lvxc.enc.annotation.EncryptablePropertySources;
import com.lvxc.enc.wrapper.EncryptableEnumerablePropertySourceWrapper;
import com.lvxc.enc.wrapper.OriginTrackedCompositePropertySource;
...
public class EncryptablePropertySourceBeanFactoryPostProcessor implements BeanFactoryPostProcessor, Ordered {
    ...
    public void postProcessBeanFactory(ConfigurableListableBeanFactory beanFactory) throws BeansException {
        ...
        EncryptablePropertyResolver propertyResolver = beanFactory.getBean(EncryptablePropertyResolverConfiguration.RESOLVER_BEAN_NAME, EncryptablePropertyResolver.class);
        EncryptablePropertyFilter propertyFilter = beanFactory.getBean(EncryptablePropertyResolverConfiguration.FILTER_BEAN_NAME, EncryptablePropertyFilter.class);
    ...
    private Stream<AnnotationAttributes> getEncryptablePropertySourcesMetadata(ConfigurableListableBeanFactory beanFactory) {
        return getBeanDefinitionsForAnnotation(beanFactory, EncryptablePropertySource.class, EncryptablePropertySources.class);
    }
