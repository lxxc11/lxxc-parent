...
public class ResponseResult<T> implements Serializable {
    ...
    public static ResponseResult<?> error(String s) {
        return error(ResultEnum.UN_SUPPORT.getCode(), s);
    }
    ...
    private static ResponseResult success = new ResponseResult(ResultEnum.CODE_SUCCESS.getCode());

    private static ResponseResult error = new ResponseResult(ResultEnum.CODE_EXCEPTION);
